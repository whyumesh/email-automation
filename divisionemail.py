...
df = pd.read_csv("Marketing Head - ( Division Wise) 24092025.csv")
...
#base_data['Request Status'].unique()
...
def complete_pivot_columns(df, col_used_f_pivot):
    ...
    incomplete_addresses = base_data[(base_data['Rto Reason'].isin([' - Incomplete Address']))]8c
...
for div, group in grouped:
    ...
    df_group = df[df['TBM Division'] == div]
    ...
    if aff_name == 'AIL':
        mail.cc = 'ishan.mithbavkar@abbott.com;ashwini.suryavanshi@abbott.com'
    elif aff_name == 'APC':
       mail.cc = 'jenita.nadar@abbott.com;ashwini.suryavanshi@abbott.com'
    elif aff_name == 'ASC':
